    ...
    <div class="main-card">
        <div class="sales-card">
            ...
            <table class="head-table">
                ...
                <tr>
                    <td class="left">Sales Receipt No. {{ $returStocks->id}}</td>
                    <td class="right"></td>
                </tr>
                <tr>
                    <td class="left">Store : {{ $returStocks->store->name }}</td>
                    <td class="right" style="float: inline-end;">Date of Sale {{ \Carbon\Carbon::parse($returStocks->created_at)->format('d F Y') }}</td>
                </tr>
                <tr>
                    <td class="left">Vehicle No. {{ $returStocks->vehicle_number}}</td>
                    <td class="right"></td>
                </tr>
                <tr>
                    <td class="left"></td>
                    <td class="right" style="float: inline-end;">Time: {{ \Carbon\Carbon::parse($returStocks->created_at)->format('h:i:s A') }}</td>
                </tr>
            </table>
            ...
            <table class="receipt-table" style="margin-bottom: 200px;">
                ...
                @php
                    $totalProducts = 0;    
                @endphp
                @foreach ($returStocks->deliveredItems as $key => $delivered_item)
                @php
