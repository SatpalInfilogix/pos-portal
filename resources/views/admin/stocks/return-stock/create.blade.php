...
@section('content')
    <div class="content">
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4>Return Stocks</h4>
                    <h6>Return stock items to the main store</h6>
                </div>
            </div>
            <ul class="table-top-head">
                <li>
                    <div class="page-btn">
                        <a href="{{ route('return-stock.index') }}" class="btn btn-secondary">
                            <i data-feather="arrow-left" class="me-2"></i>
                            Back to Retrun Stock List
                        </a>
                    </div>
                </li>
            </ul>
        ...
        <form action="{{ route('return-stock.store') }}" id="return-stock-form" method="post">
            @csrf
            <div class="card">
