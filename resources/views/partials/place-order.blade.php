            ...
            <div class="modal-body">
                <form id="place-order" method="POST">
                    ...
                    <div class="row" id="method-card">
                        <div class="col-md-6 col-lg-4 item">
                            <input type="text" name="card_digits" class="form-control"
                                placeholder="Enter Card Last 4 Digits" maxlength="4" pattern="\d{4}"
                                title="Enter card last 4 digits" oninput="validateCardDigits(this)" required>
